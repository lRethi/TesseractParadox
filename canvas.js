...
var gameMaps = [
    {
        ...
        dados: [
            ...
            { objId: "botaoIrado", exclusionId: null, x: 20, y: 20, width: 40, height: 40, cor: "#00c3ff", colPlayer: false, colMouse: false, clickableMouse: true, targetId: "msBut2", botApertado: false, objAtivo: true, playerClickable: false, mapaAlvo: 1, trocaMapa: true, botRepeatable: false, botAcao: null, botPressurePlate: false },

            { objId: "botaoIradoPlayer", exclusionId: null, x: 733, y: 560 + 30, width: 40, height: 10, cor: "#f4f800", colPlayer: false, colMouse: false, clickableMouse: false, targetId: "cbBut1", botApertado: false, objAtivo: true, playerClickable: true, mapaAlvo: 0, trocaMapa: false, botRepeatable: false, botAcao: "desativa", botPressurePlate: false },
            { objId: "botaoDaParede", exclusionId: null, x: 733, y: 436, width: 40, height: 40, cor: "#00c3ff", colPlayer: false, colMouse: false, clickableMouse: true, targetId: "msBut1", botApertado: false, objAtivo: true, playerClickable: false, mapaAlvo: 0, trocaMapa: true, botRepeatable: false, botAcao: "desativa", botPressurePlate: false },
